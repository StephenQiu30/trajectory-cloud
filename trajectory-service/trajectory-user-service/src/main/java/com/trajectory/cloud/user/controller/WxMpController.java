...
import com.trajectory.cloud.api.user.model.dto.WxMpCheckRequest;
...
public class WxMpController {
     ...
     * 微信校验
     *
     * @param request 微信校验请求
     * @return String
     */
    @GetMapping("/")
    public String check(@ModelAttribute WxMpCheckRequest request) {
        log.info("check");
    ...
    public String setMenu() throws WxErrorException {
        ...
        wxMenuButton3SubButton1.setUrl("https://stephenqhd30.github.io/");
